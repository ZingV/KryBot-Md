...
let buton = [
{ callButton: {displayText: `Instagram`, url: `https://instagram.com/bxzingv/`} },
{ urlButton: { displayText: `Call Owner`, phoneNumber : `+6287729323961`} },
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
    ...
    + 'FN:Kry\n'
    + 'ORG:Kry;\n'
    + 'item1.TEL;type=CELL;type=VOICE;waid=6287729323961:+62 877-2932-3961\n' 
    + 'item1.X-ABLabel:Creator Chitanda - MDt\n'
    + 'item2.EMAIL;type=INTERNET:cakzing81@gmail.com\n'
    + 'item2.X-ABLabel:Email\n'
    + 'item3.URL:https://instagram.com/bxzingv\n'
    + 'item3.X-ABLabel:Instagram\n'
    + 'item4.ADR:;;Indonesia;;;;\n'
    + 'item4.X-ABLabel:Region\n'
    + 'END:VCARD'
zaki.sendMessage(m.chat, { contacts: { displayName: 'Kry', contacts: [{ vcard }] } }, { quoted: m })
            }
            break
            case 'list': case 'menu': case 'help': case '?': {
                const Tag = '6287729323961'
